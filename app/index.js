...
var _mainMenu = __webpack_require__(/*! ./mainComponents/mainMenu */ "./dev/js/mainComponents/mainMenu.jsx");
...
function createWindow() {
	exports.win = win = new _electron.BrowserWindow({
		show: false,
		width: 1000,
		height: 700,
		minWidth: 1000,
	...
	_electron.Menu.setApplicationMenu(_mainMenu2.default.menu);
...
/***/ "./dev/js/mainComponents/helpDialogs.jsx":
/*!***********************************************!*\
  !*** ./dev/js/mainComponents/helpDialogs.jsx ***!
  \***********************************************/
/*! no static exports found */
...
exports.default = {
	...
	displayFileInfo: function displayFileInfo() {
		_electron.dialog.showMessageBox({
			type: "none",
			buttons: ["Close"],
	...
	displayAuthors: function displayAuthors() {
...
/***/ "./dev/js/mainComponents/mainMenu.jsx":
/*!********************************************!*\
  !*** ./dev/js/mainComponents/mainMenu.jsx ***!
  \********************************************/
/*! no static exports found */
...
var _openSaveDialogs = __webpack_require__(/*! ./openSaveDialogs */ "./dev/js/mainComponents/openSaveDialogs.jsx");

var _openSaveDialogs2 = _interopRequireDefault(_openSaveDialogs);

var _helpDialogs = __webpack_require__(/*! ./helpDialogs */ "./dev/js/mainComponents/helpDialogs.jsx");

var _helpDialogs2 = _interopRequireDefault(_helpDialogs);

var _index = __webpack_require__(/*! ../index */ "./dev/js/index.jsx");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function ipcSend(msgType, obj) {
	_index.win.webContents.send(msgType, obj);
} /*
...
exports.default = {
	menu: _electron.Menu.buildFromTemplate([{
		label: "File",
		type: "submenu",
		submenu: [{
			label: 'Dev Tools',
			...
			click: _openSaveDialogs2.default.openFile
		}, {
			label: "Save as",
			type: "submenu",
			submenu: [{
				label: "Incidence matrix",
				click: _openSaveDialogs2.default.saveAsIncidenceMatrix
			}, {
				label: "Adjacency matrix",
				click: _openSaveDialogs2.default.saveAsAdjacencyMatrix
			}, {
				label: "Edges/Vertices format",
				accelerator: "CommandOrControl+S",
				click: _openSaveDialogs2.default.saveAsEdgesVertices
			}, {
				label: "PNG Image",
				click: _openSaveDialogs2.default.saveAsImage
			}]
		}, {
			label: "Exit",
		...
		submenu: [{
			label: "Help",
			accelerator: "F1",
			click: _helpDialogs2.default.displayHelp
		}, {
			label: "File format info",
			click: _helpDialogs2.default.displayFileInfo
		}, {
			label: "Authors",
			click: _helpDialogs2.default.displayAuthors
		}]
	}])
};
...
/***/ "./dev/js/mainComponents/openSaveDialogs.jsx":
/*!***************************************************!*\
  !*** ./dev/js/mainComponents/openSaveDialogs.jsx ***!
  \***************************************************/
/*! no static exports found */
...
var _saveFileTools = __webpack_require__(/*! ./saveFileTools */ "./dev/js/mainComponents/saveFileTools.jsx");
...
exports.default = {
	...
	saveAsIncidenceMatrix: function saveAsIncidenceMatrix() {
	...
	saveAsAdjacencyMatrix: function saveAsAdjacencyMatrix() {
		_electron.dialog.showSaveDialog({
			title: "Save as incidence matrix",
	...
	saveAsEdgesVertices: function saveAsEdgesVertices() {
		_electron.dialog.showSaveDialog({
			title: "Save as incidence matrix",
	...
	saveAsImage: function saveAsImage() {
		_electron.dialog.showSaveDialog({
			...
			_electron.ipcMain.once("send-save-image", function (sender, obj) {
				_fs2.default.writeFile(filename, obj, 'base64', function (err) {
					if (err) return ipcSend("save-error", err);
					ipcSend("save-success", null);
				});
			});
...
/***/ "./dev/js/mainComponents/saveFileTools.jsx":
/*!*************************************************!*\
  !*** ./dev/js/mainComponents/saveFileTools.jsx ***!
  \*************************************************/
/*! no static exports found */
...
var _raw = __webpack_require__(/*! babel-runtime/core-js/string/raw */ "./node_modules/babel-runtime/core-js/string/raw.js");
...
var _lib = __webpack_require__(/*! xregexp/lib */ "./node_modules/xregexp/lib/index.js");
...
function evfDecode(data) {
	...
	var edgesGroup = (0, _lib2.default)(r(_templateObject), 's');
	var edgeEntry = (0, _lib2.default)(r(_templateObject2), 'gy');
	var verticesGroup = (0, _lib2.default)(r(_templateObject3), 's');
	var vertexEntry = (0, _lib2.default)(r(_templateObject4), 'gy');

	var edgesMatch = _lib2.default.exec(data, edgesGroup);
	var verticesMatch = _lib2.default.exec(data, verticesGroup);
	...
	if (verticesMatch) {
		...
		var lastIdx = 0;
		var scannedText = '';
		_lib2.default.forEach(verticesText, vertexEntry, function (match, i) {
			console.log(match);
			lastIdx = i;
	...
	if (edgesMatch) {
		...
		var _lastIdx = 0;
		var _scannedText = '';
		_lib2.default.forEach(edgesText, edgeEntry, function (match, i) {
			console.log(match);
			_lastIdx = i;
			var source = null;
			var target = null;
...
module.exports = { "default": __webpack_require__(/*! core-js/library/fn/number/is-integer */ "./node_modules/babel-runtime/node_modules/core-js/library/fn/number/is-integer.js"), __esModule: true };
...
module.exports = { "default": __webpack_require__(/*! core-js/library/fn/string/raw */ "./node_modules/babel-runtime/node_modules/core-js/library/fn/string/raw.js"), __esModule: true };
...
__webpack_require__(/*! ../../modules/es6.number.is-integer */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/es6.number.is-integer.js");
module.exports = __webpack_require__(/*! ../../modules/_core */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/_core.js").Number.isInteger;
...
__webpack_require__(/*! ../../modules/es6.object.define-properties */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/es6.object.define-properties.js");
...
__webpack_require__(/*! ../../modules/es6.object.freeze */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/es6.object.freeze.js");
module.exports = __webpack_require__(/*! ../../modules/_core */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/_core.js").Object.freeze;


/***/ }),

/***/ "./node_modules/babel-runtime/node_modules/core-js/library/fn/string/raw.js":
/*!**********************************************************************************!*\
  !*** ./node_modules/babel-runtime/node_modules/core-js/library/fn/string/raw.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ../../modules/es6.string.raw */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/es6.string.raw.js");
module.exports = __webpack_require__(/*! ../../modules/_core */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/_core.js").String.raw;
...
/***/ "./node_modules/babel-runtime/node_modules/core-js/library/modules/_is-integer.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/babel-runtime/node_modules/core-js/library/modules/_is-integer.js ***!
  \****************************************************************************************/
/*! no static exports found */
...
$export($export.S, 'Number', { isInteger: __webpack_require__(/*! ./_is-integer */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/_is-integer.js") });
...
var isObject = __webpack_require__(/*! ./_is-object */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/_is-object.js");
var meta = __webpack_require__(/*! ./_meta */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/_meta.js").onFreeze;

__webpack_require__(/*! ./_object-sap */ "./node_modules/babel-runtime/node_modules/core-js/library/modules/_object-sap.js")('freeze', function ($freeze) {
...
/***/ "./node_modules/babel-runtime/node_modules/core-js/library/modules/es6.string.raw.js":
/*!*******************************************************************************************!*\
  !*** ./node_modules/babel-runtime/node_modules/core-js/library/modules/es6.string.raw.js ***!
  \*******************************************************************************************/
/*! no static exports found */
...
var _blocks = _interopRequireDefault(__webpack_require__(/*! ../../tools/output/blocks */ "./node_modules/xregexp/tools/output/blocks.js"));
...
var _unicodeBlocks = _interopRequireDefault(__webpack_require__(/*! ./addons/unicode-blocks */ "./node_modules/xregexp/lib/addons/unicode-blocks.js"));
